...
// this plugin is for the reference, we will not use this plugin, we will use CustomAPICreateOpportunity which is more optimized and have better performance.
namespace MultiYearDeal.Plugins
{
    public class CustomAPICreateOpportunityTemp : IPlugin
    {
        enum ats_type_opp
        {
